...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-3d6d0da3');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-3d6d0da3');}
...
function clearFlash(){dieView.classList.remove('rl-win-3d6d0da3');dieView.classList.remove('rl-lose-3d6d0da3');if(frameEl){frameEl.classList.remove('rl-win-3d6d0da3');frameEl.classList.remove('rl-lose-3d6d0da3');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-3d6d0da3');if(frameEl){frameEl.classList.add('rl-win-3d6d0da3');}}else{dieView.classList.add('rl-lose-3d6d0da3');if(frameEl){frameEl.classList.add('rl-lose-3d6d0da3');}}
...
var brandEl=document.querySelector('.rl-brand-3d6d0da3');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
